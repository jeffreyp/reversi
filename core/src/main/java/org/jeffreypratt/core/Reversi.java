...
public class Reversi extends SceneGame {
    ...
    public Reversi (Platform plat) {
        ...
        // create a layer that just draws a gray background
    ...
    private void endGame () {
        // count up the pieces of each color
        ...
        // when the player clicks anywhere, end the game
